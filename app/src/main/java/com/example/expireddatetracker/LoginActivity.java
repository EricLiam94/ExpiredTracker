...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, OnClickListener {
    ...
    public void onClick(View v) {
        ...
        View popupView = layoutInflater.inflate(R.layout.activity_signup, null);
        ...
        final EditText email  = popupView.findViewById(R.id.sign_email);
        final EditText password = popupView.findViewById(R.id.sign_password);
        final ImageView close = popupView.findViewById(R.id.sign_close);
        ...
        Button signBt = popupView.findViewById(R.id.sign_button);
        signBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String s1 = (String) email.getText().toString();String s2 = password.getText().toString();
                Signup s = new Signup();
                s.execute(s1,s2);
            }
